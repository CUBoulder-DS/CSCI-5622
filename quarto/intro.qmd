...
1. Is there noticable trends in prices over time, over all products?
    * It was observed that, on the whole, prices [decreased over time](https://cuboulder-ds.github.io/CSCI-5622/data.html#fig-dupehist).
2. Are there price trends over time within a specific product category?
    * Smart Home devices consistently had prices decrease, along with: Gift Cards, Computer Monitors, and Travel Accessories. Makeup, Electrical Equipment, and Sports & Outdoors had their prices mostly increase. See [here](https://cuboulder-ds.github.io/CSCI-5622/data.html#fig-dupecats)
3. Are there price/rating similarities between the products with similar titles/categories?
   * No noticable trends were observed.
4. Do ratings have any correlation with the price of products?
   * No noticable trends were [observed](https://cuboulder-ds.github.io/CSCI-5622/data.html#fig-prstars).
5. Do ratings have any correlation with the product category?
   * No noticable trends were observed.
6. Do stars and the numer of reviews have a noticable correlation?
   * There are many products with zero (or close to) reviews that have a variable amount of stars; excluding those, [as reviews increase, the stars tend to be high.](https://cuboulder-ds.github.io/CSCI-5622/data.html#fig-starreview). Clustering methods found this relation as well.
7. Can the "Best Seller" label of a product be predicted based on all other factors?
   * Not with this dataset; classification decision trees tended to classify everything as "Not a Best Seller" in order to achieve a [false high accuracy rate](https://cuboulder-ds.github.io/CSCI-5622/models/dtrees.html#tbl-metrics). This was likely due to the extreme imbalance in the label. Neural networks [performed better](https://cuboulder-ds.github.io/CSCI-5622/models/nn.html#tbl-pm) with the imbalance but still struggled.
8. Can the price of a product be predicted based on all other factors?
   * Regression decision trees performed [poorly](https://cuboulder-ds.github.io/CSCI-5622/models/dtrees.html#fig-reg1) at predicting price based on all other features.
9.  Can the category of a product be predicted based on the description/title?
    * Yes, Naive Bayes methods performed exceedingly well as correctly categorizing products, especially if they has highly-correlated keywords in the title or were in a popular category.
10. Can the price difference of a product over time be predicted based on all other factors?
    * Neural networks [performed adequately](https://cuboulder-ds.github.io/CSCI-5622/models/nn.html#fig-pd-diff) at this, but still could not predict the amount of a price increase (only could handle a price decrease) nor handle extreme/large price differences. SVMs [performed poorly](https://cuboulder-ds.github.io/CSCI-5622/models/svm.html#tbl-acc), indicating a need for a more comprehensive dataset.
